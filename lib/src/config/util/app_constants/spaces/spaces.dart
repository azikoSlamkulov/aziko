...
class AppSized {
  ...
  static SizedBox h45 = const SizedBox(height: 45);
  static SizedBox h47 = const SizedBox(height: 47);
  ...
  static SizedBox h100 = const SizedBox(height: 100);
  ...
  static SizedBox w45 = const SizedBox(width: 45);
  static SizedBox w50 = const SizedBox(width: 50);
  static SizedBox w55 = const SizedBox(width: 55);
  static SizedBox w60 = const SizedBox(width: 60);
  static SizedBox w65 = const SizedBox(width: 65);
  static SizedBox w70 = const SizedBox(width: 70);
  static SizedBox w75 = const SizedBox(width: 75);
  static SizedBox w80 = const SizedBox(width: 80);
  static SizedBox w85 = const SizedBox(width: 85);
  static SizedBox w90 = const SizedBox(width: 90);
  static SizedBox w95 = const SizedBox(width: 95);
}
