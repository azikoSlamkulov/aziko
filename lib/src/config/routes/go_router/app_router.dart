...
import 'package:aziko/src/config/routes/go_router/router_utils.dart';
...
import '../../../module/favorites/presentation/pages/widgets_page.dart';
...
import '../../../module/user_profile/presentation/views/profile_viwe.dart';
  ...
  late final GoRouter _goRouter = GoRouter(
    ...
    redirect: (context, state) {
      ...
      final bool onBoarding =
          state.matchedLocation == AppPage.onBoarding.toPath;
      final bool signUp = state.matchedLocation == AppPage.signUp.toPath;
      final bool signIn = state.matchedLocation == AppPage.signIn.toPath;
      final bool passwordRecovery =
          state.matchedLocation == AppPage.passwordRecovery.toPath;
