...
import 'package:aziko/src/module/widgets/payment_method/payment_method.dart';
...
class PaymentMethodsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<PaymentMethodsCubit>()..getAllPaymentCards(),
...
class NestedPaymentMethodsView extends StatelessWidget {
  ...
  static PaymentCardEntity _paymentCard = PaymentCardEntity();
      ...
      child: Column(
        children: [
          ...
          CardNumberTextFormField(
            ...
            //suffixIcon: AppAssets.mastercardWhite(width: 5.h, height: 5.h),
          ),
          10.verticalSpace,
          ExpireDateTextFormField(
          ...
          CustomElevatedButton(
            onPressed: () {
              if (formKey.currentState!.validate()) {
                ...
                //     year: CardUtils.getExpiryDate(expireDateController.text)[1],
                ...
                log('cardNumber ====>>>> ${CardUtils.getCleanedNumber(cardNumberController.text)}');
                log('month ====>>>> ${CardUtils.getExpiryDate(expireDateController.text)[0]}');
                log('year ====>>>> ${CardUtils.getExpiryDate(expireDateController.text)[1]}');
                log('cvv ====>>>> ${int.parse(cvvController.text)}');
              }
