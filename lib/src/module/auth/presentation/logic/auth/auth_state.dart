...
class SentPasswordState extends AuthState {
  final bool isSent;
  const SentPasswordState(this.isSent);
  @override
...
class AuthFailureState extends AuthState {
  ...
  const AuthFailureState(this.message, this.authMethod);
  @override
  List<Object> get props => [message, authMethod];
}
